	...
	int cmdShow)
{
	...
	LPCSTR texturesToUse[] = { "Images\\fighter.png", "Images\\fighter2.png", "Images\\fighter3.png", "Images\\fighter4.png", "Images\\LAZER.png" };
	...
	LPCSTR bkgTexturesToUse[] = { "Images/SPACE.png", "Images/Start.png", "Images/Space end.png" };
	...
	string outputMsg;
	string strMsg[] = { "A = left, D = right, Space = shoot","Shoot down the ships", "Space Pirates", "The booty be arrs!","Thanks for playing!" };
	...
	while (pgmWNDMgr->isWNDRunning())
	{
		...
		case MENU:
			...
			// Show lines "Space Pirates, Be a pirate and shoot down ships"
			outputMsg = strMsg[2];
		...
		case PLAYING:
			...
			spriteBkgd.render();
			{
				//create asteroids on screen 
				vector<cAsteroid*>::iterator asteroidIterator = theAsteroids.begin();
				while (asteroidIterator != theAsteroids.end())
				{
					if ((*asteroidIterator)->isActive() == false)
					{
						//destroy asteroid sprite and increase score by 1.
			...
			theFontMgr->getFont("Funk")->printText("Space Pirates", FTPoint(800.0f, 750.0f, 0.0f));
